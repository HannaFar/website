<template>
  <div class="hello">
    <div class="social" :class="{blur: showMenu, hide: viewSection }">
      <a href="https://www.linkedin.com/in/hanna-farag-295355111/" target="_blank">
        <svg class="icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="430.117px" height="430.118px" viewBox="0 0 430.117 430.118" style="enable-background:new 0 0 430.117 430.118;"
        xml:space="preserve">
        <g>
      ...
      <a href="https://github.com/HannaFar" target="_blank">
        <svg class="icon" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="438.536px" height="438.536px" viewBox="0 0 438.536 438.536" style="enable-background:new 0 0 438.536 438.536;"
        xml:space="preserve">
        <g>
          <g>
...
.icon {
  ...
  &:hover {
      ...
      transition-timing-function: .3s ease-out;
